...
for component in launcher zlux-core zss apiml-common-lib common-java-lib apiml-sample-extension zaas cloud-gateway caching-service discovery api-catalog explorer-jes explorer-mvs explorer-uss; do
