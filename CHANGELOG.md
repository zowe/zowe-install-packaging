...
- Enhancement: Implemented the `zowe.network.allowedDomains` allowlist property for URL domains (v2). This feature validates all service registration metadata against a trusted domain allowlist. For details, see the `zowe.network.allowedDomains` feature in Zowe API Mediation Layer. [#4813](https://github.com/zowe/zowe-install-packaging/pull/4813)
