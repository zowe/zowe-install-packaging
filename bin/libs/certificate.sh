...
keyring_run_zwekring_jcl() {
  ...
  if [ -z "${ip_address}" ]; then
    print_error_and_exit "Error ZWEL0156E: Please enter an IP address in either the subject alternative name (zowe.setup.certificate.san) or external domain (zowe.externalDomains) in the Zowe YAML configuration file." "" 156
  fi
