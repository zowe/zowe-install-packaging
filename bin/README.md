...
**These variables are generated by Zowe. Modifying the value of these variables is not recommended.**
...
- `ZWE_ALLOWED_DOMAINS` contains a list of all enabled domains that API Mediation Layer will allow.
