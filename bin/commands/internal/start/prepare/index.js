...
function validateComponents(enabledComponents) {
    ...
    let privateErrors = 0;
    std.setenv('ZWE_PRIVATE_ERRORS_FOUND', '0');
    enabledComponents.forEach((componentId) => {
...
function configureComponents(componentEnvironments, enabledComponents) {
