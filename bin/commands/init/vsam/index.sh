...
if [ -z "${vsam_name}" ]; then
  print_error_and_exit "Error ZWEL0149E: Zowe Caching Service VSAM data set name (components.caching-service.storage.vsam.name) is not defined in Zowe YAML configuration file." "" 157
fi
