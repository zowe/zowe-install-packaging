...
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.workspaceDirectory" "${ZWE_PRIVATE_CONTAINER_WORKSPACE_DIRECTORY}"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.logDirectory" "${ZWE_PRIVATE_CONTAINER_LOG_DIRECTORY}"

iterator_index=0
for host in $(echo "${ZWE_CLI_PARAMETER_DOMAINS}" | sed 's#[,]# #g'); do
  update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.externalDomains[${iterator_index}]" "${host}"
  iterator_index=$(expr $iterator_index + 1)
done

update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.externalPort" "${ZWE_CLI_PARAMETER_EXTERNAL_PORT}"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.gateway.port" "7554"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.zaas.port" "7558"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.discovery.port" "7553"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.api-catalog.port" "7552"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.caching-service.port" "7555"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.app-server.port" "7556"

update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.gateway.enabled" "true"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.zaas.enabled" "true"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.discovery.enabled" "true"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.api-catalog.enabled" "true"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.caching-service.enabled" "true"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.app-server.enabled" "true"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.explorer-jes.enabled" "true"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.explorer-mvs.enabled" "true"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.explorer-uss.enabled" "true"

update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.gateway.apiml.security.x509.externalMapperUrl" ""
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.gateway.apiml.security.authorization.endpoint.url" ""
zaas_auth_provider=$(read_yaml_configmgr "${temp_dir}/zowe.yaml" ".components.gateway.apiml.security.authorization.endpoint.provider")
...
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.gateway.apiml.security.authorization.endpoint.provider" ""
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.discovery.replicas" "1"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "components.caching-service.storage.mode" ""

update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.environments.ZWED_agent_host" "${original_zss_host}"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.environments.ZWED_agent_https_port" "${original_zss_port}"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.environments.ZOWE_ZLUX_TELNET_HOST" "${original_zss_host}"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.environments.ZOWE_ZLUX_SSH_HOST" "${original_zss_host}"

update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.certificate.keystore.file" "${ZWE_PRIVATE_CONTAINER_KEYSTORE_DIRECTORY}/keystore.p12"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.certificate.truststore.file" "${ZWE_PRIVATE_CONTAINER_KEYSTORE_DIRECTORY}/truststore.p12"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.certificate.pem.certificateAuthorities" "${ZWE_PRIVATE_CONTAINER_KEYSTORE_DIRECTORY}/ca.cer"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.certificate.pem.key" "${ZWE_PRIVATE_CONTAINER_KEYSTORE_DIRECTORY}/keystore.key"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.certificate.pem.certificate" "${ZWE_PRIVATE_CONTAINER_KEYSTORE_DIRECTORY}/keystore.cer"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.certificate.keystore.alias" "${ZWE_zowe_certificate_keystore_alias}"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.certificate.keystore.password" "${ZWE_zowe_certificate_keystore_password}"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.certificate.keystore.type" "${ZWE_zowe_certificate_keystore_type}"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.certificate.truststore.password" "${ZWE_zowe_certificate_truststore_password}"
update_zowe_yaml_configmgr "${temp_dir}/zowe.yaml" "zowe.certificate.truststore.type" "${ZWE_zowe_certificate_truststore_type}"
