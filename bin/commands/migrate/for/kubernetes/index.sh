...
update_zowe_yaml "${temp_dir}/zowe.yaml" "zowe.certificate.keystore.file" "/home/zowe/keystore/keystore.p12"
update_zowe_yaml "${temp_dir}/zowe.yaml" "zowe.certificate.truststore.file" "/home/zowe/keystore/truststore.p12"
update_zowe_yaml "${temp_dir}/zowe.yaml" "zowe.certificate.pem.certificateAuthorities" "/home/zowe/keystore/ca.cer"
update_zowe_yaml "${temp_dir}/zowe.yaml" "zowe.certificate.pem.key" "/home/zowe/keystore/keystore.key"
update_zowe_yaml "${temp_dir}/zowe.yaml" "zowe.certificate.pem.certificate" "/home/zowe/keystore/keystore.cer"
