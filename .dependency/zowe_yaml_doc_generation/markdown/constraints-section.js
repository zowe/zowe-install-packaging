...
const valueConstraints = [
    ...
    // logic constraints
    {
        ...
        mdGenerator: (oneOfList, extraArgs) => { // TODO args are out of place
            ...
            const { curSchemaKey, currentFileName } = extraArgs;
    ...
    },
    {
        ...
        mdGenerator: (ifSchema, extraArgs) => {
            const { curSchemaKey, thenSchema, elseSchema, currentFileName } = extraArgs;
            ...
            if (key === propKey) {
                constraints.push(mdGenerator(constraint,
                    // TODO this extra args object is bad
                    {
                        ...
                        currentFileName: curSchemaNode.metadata.fileName,
                        curSchemaKey: curSchemaNode.metadata.curSchemaKey
                    }
                ));
            }
        }
