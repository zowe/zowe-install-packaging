...
"""
  ...
  pipeline.createStage(
    ...
    isSkippable: true,
    stage : {
      sh """docker build https://github.com/1000TurquoisePogs/zowe-dockerfiles.git#s390x:dockerfiles/zowe-release/amd64/zowe-v1-lts --build-arg PAX_FILE=${WORKSPACE}/.pax/zowe.pax"""
    }
  )
