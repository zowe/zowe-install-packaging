...
describe(`test zLux server https://${process.env.ZOWE_EXTERNAL_HOST}:${process.env.ZOWE_ZLUX_HTTPS_PORT}`, function() {
  ...
  describe('GET /', function() {
    it('should redirect to ./zlux/ui/v1/ZLUX/plugins/org.zowe.zlux.bootstrap/web/', async function() {
      ...
      expect(res.headers.location).to.equal('./zlux/ui/v1/ZLUX/plugins/org.zowe.zlux.bootstrap/web/');
    });
