...
Perform very fast local-only testing with **no** Zowe Server running. Tests may be either unit or integration.
...
- Node.js, with recommended [v20.x LTS](https://nodejs.org/docs/latest-v20.x/api/)
