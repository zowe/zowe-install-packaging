...
const zoweSchema = zoweYamlSchema as {
                ...
                parmlib: {
                  ...
                  properties: {
                    keys: {
                      ...
                      examples: ['key.sample.1: list', 'key.sample.2: list'];
                    };
                  };
                };
              };
  ...
  $defs: {
    ...
    certificate: {
      oneOf: [{ $ref: '#/$defs/pkcs12-certificate' }, { $ref: '#/$defs/keyring-certificate' }];
    };
    'pkcs12-certificate': {
      type: 'object';
      additionalProperties: false;
...
type ZoweYamlType = FromSchema<typeof zoweSchema, { references: [typeof serverCommonSchema] }>;

export default ZoweYamlType;
