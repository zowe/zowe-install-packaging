...
for (const test of testCases) {
  ...
  assertEqualsStrict(defaultMode.doCheck, test.default.doCheck)
  assertEqualsStrict(defaultMode.warnOnly, test.default.warnOnly)

  assertEqualsStrict(portsMode.doCheck, test.ports.doCheck)
  assertEqualsStrict(portsMode.warnOnly, test.ports.warnOnly)

  assertEqualsStrict(zosmfMode.doCheck, test.zosmf.doCheck)
  assertEqualsStrict(zosmfMode.warnOnly, test.zosmf.warnOnly)
