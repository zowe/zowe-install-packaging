...
if [[ $ZOWE_ZSS_SERVER_NAME == "" ]]
then
    ZOWE_ZSS_SERVER_NAME=ZWESIS_STD
    echo "  ZOWE_ZSS_SERVER_NAME not specified:  Defaulting to ZWESIS_STD"
fi
...
echo "  ZOWE_ZSS_SERVER_NAME="$ZOWE_ZSS_SERVER_NAME >> $LOG_FILE
