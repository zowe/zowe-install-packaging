...
# ZOWE_APIM_GATEWAY_PORT        - The port the gateway service will use
...
options="-Xms32m -Xmx256m \
  ...
  -Dapiml.service.port=${ZOWE_APIM_GATEWAY_PORT} \
  -Dapiml.service.discoveryServiceUrls=https://${ZOWE_EXPLORER_HOST}:${ZOWE_APIM_DISCOVERY_PORT}/eureka/ \
  -Dapiml.service.preferIpAddress=true \
  -Dapiml.service.ipAddress=${ZOWE_IPADDRESS} \
