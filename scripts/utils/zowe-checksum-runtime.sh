...
#           This might be $ROOT_DIR in Jenkins?
...
#           RefRuntimeHash.txt file, or they will be flagged as extra.  
...
# create a list of files to be hashed
...
#       '$hashPath/RefRuntimeHashHash.txt'
#     ]
#   )
