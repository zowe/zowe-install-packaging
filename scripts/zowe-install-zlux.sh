...
pluginDefaults=$appServer/pluginDefaults/org.zowe.zlux.ng2desktop/ui/launchbar/plugins
...
# TODO why is this not in pax?
_cmd mkdir -p $pluginDefaults

# TODO why are these not in pax?
# Add default config files
echo "  Copy of $config/<...> into $appServer/<...>" >> $LOG_FILE
_cmd cp -f $config/pinnedPlugins.json $pluginDefaults/
