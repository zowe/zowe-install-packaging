...
#% Stop Zowe server started task.
#%
#% Invocation arguments:
#% -?            show this help message
#% -c zowe.yaml  stop server using the specified input file
#% -d            enable debug messages
#%
#% If -c is not specified, then the server is stoped using default
#% values.
...
# issue STOP operator command
_cmd $scripts/opercmd.rex $debug "P $ZOWE_STC_ZOWE"
