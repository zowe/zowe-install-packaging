...
list="$list files/zss/SAMPLIB/ZWESIPRG.txt" # ZSS PROGxx
list="$list files/zss/SAMPLIB/ZWESIP00.txt" # ZSS config
list="$list files/zss/SAMPLIB/ZWESISCH.txt" # ZSS SCHEDxx
