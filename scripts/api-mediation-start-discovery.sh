...
STATIC_DEF_CONFIG="$here/../api-defs"
...
options="-Xms32m -Xmx256m \
  ...
  -Dapiml.discovery.allPeersUrls=https://${ZOWE_EXPLORER_HOST}:${ZOWE_APIM_DISCOVERY_PORT}/eureka/ \
  -Dapiml.service.hostname=${ZOWE_EXPLORER_HOST} \
  -Dapiml.service.port=${ZOWE_APIM_DISCOVERY_PORT} \
