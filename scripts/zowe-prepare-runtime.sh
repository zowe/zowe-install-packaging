...
awk '/"com.rs.mvd.vt",/{print "\"com.ibm.explorer-jes\","}1' $pinnedPluginsDirectory/pinnedPlugins.json > $TEMP_DIR/tempPinned
awk '/"com.rs.mvd.vt",/{print "\"com.ibm.explorer-mvs\","}1' $TEMP_DIR/tempPinned > $TEMP_DIR/tempPinned2
awk '/"com.rs.mvd.vt",/{print "\"com.ibm.explorer-uss\","}1' $TEMP_DIR/tempPinned2 > $pinnedPluginsDirectory/pinnedPlugins.json
